...
export const TopMenu: FC = () => {
  ...
  return (
    <>
      <div className="flex flex-1 flex-col items-center minCustom:gap-[12px] custom:gap-[8px] blurMe">
        {
          // @ts-ignore
          user?.orgId &&
            // @ts-ignore
      ...
      <div className="flex flex-col items-center minCustom:gap-[12px] custom:gap-[8px] blurMe">
        {secondMenu
          .filter((f) => {
            if (f.hide) {
              return false;
